...
## plot1.R - script for assessment 1, Coursera MOOC: Exploratory Data Analysis, July 2014
...
prepare_data <- function(filename){
    ...
    data$Date <- paste(data$Date,data$Time,sep=" ")#OK
...
write_datafile <- function(selecteddata,datafilename){
...
create_plot <- function(working_dir){
    ...
    ## 0) Introduction
    cat("\n\nplot1.R - \n\nIntroduction:\n 
        This script is used to create 'plot1.png' saved into the user-selected working 
        ...
        \nNotes:\n
        The script was developed on Windows 7 x64 Professional SP1 with all updates,
        and using R 3.0.2 32-bit, the appropriate Rtools version 31, and RStudio 0.98.507.
    ...
    ## 6) Plot data
    cat("\n\n Step 6. Plotting data to file, 'plot1.png' in the working folder.\n")
    ...
    ## 7) Exit
    cat("\n\n Script complete. Look for the plot1.png in the working folder.\n")
    dir(working_dir)
