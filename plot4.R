...
## plot4.R - script for assessment 1, Coursera MOOC: Exploratory Data Analysis, July 2014
...
create_plot <- function(working_dir){
    ...
    ## 0) Introduction
    cat("\n\nplot4.R - \n\nIntroduction:\n 
        This script is used to create 'plot4.png' saved into the user-selected working 
    ...
    ## 7) Exit
    cat("\n\n Script complete. Look for the plot4.png in the working folder.\n")
    dir(working_dir)
