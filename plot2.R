...
## plot2.R - script for assessment 1, Coursera MOOC: Exploratory Data Analysis, July 2014
...
create_plot <- function(working_dir){
    ...
    ## 0) Introduction
    cat("\n\nplot2.R - \n\nIntroduction:\n 
        This script is used to create 'plot2.png' saved into the user-selected working 
    ...
    ## 6) Plot data
    cat("\n\n Step 6. Plotting data to file, 'plot2.png' in the working folder.\n")
    ...
    ## 7) Exit
    cat("\n\n Script complete. Look for the plot2.png in the working folder.\n")
    dir(working_dir)
